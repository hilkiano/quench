...
export default async function RootLayout({
  ...
  return (
    <html lang={locale}>
      ...
      <body
        className={`${fredokaFont.variable} ${zzzFont.variable} ${mulishFont.variable} font-sans antialiased bg-[url('/images/bg.svg')] bg-cover bg-no-repeat bg-center bg-fixed overscroll-none overflow-hidden`}
      >
        <Toaster />
        <QueryProvider>
          <NuqsAdapter>
